...
### WebSocket Streams
- [Market streams](https://www.mexc.com/api-docs/spot-v3/websocket-market-streams) – Trade, kline, diff depth, partial depth, book ticker, mini ticker.
- [User data streams](https://www.mexc.com/api-docs/spot-v3/websocket-user-data-streams) – Account, deals, and order updates (requires listen key).
