...
A User Data Stream is valid for 60 minutes after creation.listenKey
Doing a on a will extend its validity for 60 minutes.PUTlistenKey
Doing a on a will close the stream and invalidate the .DELETElistenKeylistenKey
